...
lin1 = np.linspace(0, 50, 26, endpoint = True, retstep = True, dtype = int)
# разбивает интервал [0, 50] на (26 - 1) равных промежутков,
# возвращает 26 узлов разбиения(endpoint = False - кроме конечного узла)
# retstep возвращает шаг разбиения
# print(lin1)
